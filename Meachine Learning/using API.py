...
class TextTranslatorApp:
    ...
    def create_widgets(self):
        ...
        self.entry.grid(row=0, column=1, padx=18, pady=16)
        label2.grid(row=1, column=8, padx=10, pady=10)
        self.source_lang.grid(row=1, column=1, padx=18, pady=18)
        label3.grid(row=2, column=0, padx=18, pady=10)
        self.target_lang.grid(row=2, column=1, padx=10, pady=10)
        translate_button.grid(row=3, column=0, columnspan=2, pady=18)
